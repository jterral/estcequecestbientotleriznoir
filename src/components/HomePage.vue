  ...
  methods: {
    setBlackRice() {
      ...
      if (hour == 11 && minutes < 45) {
          ...
          message = "Ce n'est plus l'heure du riz noir mais c'est bientôt l'heure de la banane 🍌";
      } else if (hour == 16 && minutes >= 0) {
          message = "Ouiiiiiii c'est l'heure de la banane 🍌🥳";
          description = "L'abus de banane est dangereux pour la santé, à consommer avec modération.";
      } else if (hour > 12) {
